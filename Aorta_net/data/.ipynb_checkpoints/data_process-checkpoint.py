...
def rmake_mask():
    ...
    path = "/home/wangtao/yml/data/p2_nii/internal/jfj/P1/dis/dml/fb/DICOM5/PA2" #
...
def get_files_list():
    path="/media/wangtao/yml_data2/data_use/p2_nii/external/"#CT_CTA internal
