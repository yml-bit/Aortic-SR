...
def config():
    ...
    parser.add_argument('--output', type=str, default='./output/3DUXNET', help='Output folder for both tensorboard and the best model')
    parser.add_argument('--image_save', type=str, default='/media/bit301/data/yml/data/p2_nii/test/3DUXNET', help='images')
    ...
    parser.add_argument('--trained_weights', default='./output/3DUXNET/0128/01_30_09.pth', help='Path of pretrained/fine-tuned weights')
