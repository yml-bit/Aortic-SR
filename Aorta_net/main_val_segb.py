...
def config():
    ...
    parser.add_argument('--output', type=str, default='./output/SwinUNETR', help='Output folder for both tensorboard and the best model')
    parser.add_argument('--image_save', type=str, default='/media/bit301/data/yml/data/p2_nii/test/SwinUNETR', help='images')
    ...
    parser.add_argument('--network', type=str, default='SwinUNETR',help='Network models: {TransBTS, nnFormer, UNETR, SwinUNETR, 3DUXNET}')
    parser.add_argument('--trained_weights', default='./output/SwinUNETR/0128/02_10_17.pth', help='Path of pretrained/fine-tuned weights')
    ...
    parser.add_argument('--cache_rate', type=float, default=0.02, help='Cache rate to cache your dataset into GPUs')#0.1
