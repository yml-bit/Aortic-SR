...
if __name__ == '__main__':
    ...
    for line in f.readlines():#tile_step_size=0.75较好处理官腔错位问题
            ...
            path=line.split('\n')[0]
            # path="/media/bit301/data/yml/data/p2_nii/external/lz/dis/dml/PA12/0.nii.gz"
            # path = "/media/bit301/data/yml/data/p2_nii/external/lz/nor/PA192/0.nii.gz"
            # path = "/media/bit301/data/yml/data/p2_nii/external/test/301/0.nii.gz"
            ...
            out_put=path.replace("external","test/MedNeXtx2_075")#lo:97  x1:54  xlo2:10
