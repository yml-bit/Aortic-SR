...
nnUNet_raw = '/media/bit301/data/yml/project/python39/p2/nnUNet/DATASET/nnUNet_raw'
nnUNet_preprocessed = '/media/bit301/data/yml/project/python39/p2/nnUNet/DATASET/nnUNet_preprocessed'
nnUNet_results = '/media/bit301/data/yml/project/python39/p2/nnUNet/DATASET/nnUNet_results_MedNeXtx2'#m:medium n:no supervision nnUNet_results_MedNeXt_v2
