...
from .AortaNet.AortaV1 import Aorta1,Aorta2#增加了输出层
...
class nnUNetTrainer(object):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        # model = Aorta1(in_channels=1,n_channels=32,
        ...
        model = Aorta2(in_channels=1,n_channels=48,
            n_classes=5,exp_r=[2,3,4,4,4,4,4,3,2],#[2,3,4,4,4,4,4,3,2] [1,2,3,3,3,3,3,2,1]
            kernel_size=3,deep_supervision=True,do_res=True,
            do_res_up_down=True,block_counts=[3, 4, 8, 8, 8, 8, 8, 4, 3],#True False [3,4,4,4,4,4,4,4,3]
            checkpoint_style='outside_block')
        return model
    ...
    def on_validation_epoch_end(self, val_outputs: List[dict]):
        ...
        # weight=np.array([1, 1, 2, 5])#### [1, 1, 2, 5] [1, 1, 1.25, 1.5]
