...
class nnUNetTrainer(object):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        # model = MedNeXt(in_channels=1,n_channels=32,#原始l5
        ...
        model = MedNeXt(in_channels=1,n_channels=32,#增大通道，减少卷积核l3
            n_classes=5,exp_r=[3, 4, 8, 8, 8, 8, 8, 4, 3],
            kernel_size=3,deep_supervision=True,do_res=True,
            do_res_up_down=True,block_counts=[3, 4, 8, 8, 8, 8, 8, 4, 3],#True False
            checkpoint_style='outside_block')

        # model = MedNeXt(in_channels=1,n_channels=48,#32 48
        #     n_classes=5,exp_r=[2,3,4,4,4,4,4,3,2],
        #     kernel_size=3,deep_supervision=False,do_res=True,
